...
## 주요 연동 기능 및 가이드
- **로컬 AI 엔진 연동**: [[GEMINI]] · [[02_PC_및_시스템_환경/PC_시스템_및_하드웨어_종합_가이드]] (Ollama + Qwen 2.5 + DeepSeek-R1 연동)
- **MCP 도구 연동**: [[03_운영_및_체크리스트/세션_체크리스트_및_자동설치_가이드]] (Playwright 브라우저 제어 등)
- **설치 도구 모음**: [[03_운영_및_체크리스트/세션_체크리스트_및_자동설치_가이드]]
...
- **연동 문서**: [[GEMINI]] · [[02_PC_및_시스템_환경/PC_시스템_및_하드웨어_종합_가이드]]
...
- [[01_AI_시스템_및_도구/Google_AntiGravity_멀티에이전트_실전_가동_가이드]]
- [[03_운영_및_체크리스트/세션_체크리스트_및_자동설치_가이드]]
...
- **관련 노트**: [[03_운영_및_체크리스트/세션_체크리스트_및_자동설치_가이드]]
...
- **관련 노트**: [[01_AI_시스템_및_도구/AI_모델_명세_및_팩트검색_프로토콜]]

---

## 🔗 관련 문서
- [[01_AI_시스템_및_도구/AI_모델_명세_및_팩트검색_프로토콜]]
...
## 요금 원본
- Grok Bot은 X Premium이 아니다. [[Grok_4.6_초가성비_성능분석_및_요금_한국원화_환산_가이드]]
