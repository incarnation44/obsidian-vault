---
title: 🚀 Google Antigravity 웹사이트 감사 & /goal 자율 루프 마스터 가이드
tags:
  - antigravity
  - gemini-3-7-flash
  - slash-goal
  ...
  - lighthouse
  - web-modernization
source_url: "https://youtu.be/nPpvkQ3zxSA"
source_creator: "Google Antigravity"
...
```mermaid
graph TD
    A["1. 목표 설정 (/goal)<br>'Lighthouse 점수 100점 만점 달성'"] --> B["2. Chrome MCP 자동 감사<br>(웹사이트 로딩속도/접근성/구형 API 진단)"]
    B --> C["3. 문제점 분석 & 아티팩트 생성"]
    C --> D["4. 자율 코드 수정 & 최신 웹 표준 적용"]
    D --> E["5. 브라우저 백그라운드 재측정 & 검증"]
    E -->|100점 미달성 시| D
    E -->|100점 달성 완료| F["6. 최종 완료 아티팩트 보고서 발행 ⭐"]
```
