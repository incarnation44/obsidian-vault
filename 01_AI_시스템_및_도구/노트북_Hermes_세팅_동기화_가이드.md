...
| 항목 | 본체 | 노트북 | 비고 |
|------|------|--------|------|
| 하드웨어 | Ryzen 5600XT, RX 6600, 32GB | Dell 노트북 사양 | `decisions.md`에 각 기기 사양 별도 기록 |
| WSL 사용 | 본체: WSL2 기본 | 노트북: 동일하게 구성 | 커널 버전만 다를 수 있음 |
| GPU 가속 | RX 6600 (ROCm/CPU 폴백) | 노트북 GPU 확인 후 설정 | 로컬 LLM 돌릴 때만 관련 |
