---
title: 🖥️ ASUS Ascent QN10 - 세계 최초 80 TOPS NPU 탑재 차세대 AI 미니 PC
tags:
  - asus
  - mini-pc
  - snapdragon-x2-elite
  ...
  - on-device-ai
  - local-llm
source_url: "https://youtu.be/mYmXNb9U3T0"
source_creator: "ASUS / YouTube"
...
```mermaid
graph TD
    A["ASUS Ascent QN10 (720g)"] --> B["18코어 Snapdragon X2 Elite CPU"]
    A --> C["80 TOPS Qualcomm Hexagon NPU<br>(로컬 AI 전용 가속기)"]
    A --> D["32GB LPDDR5x (9600MHz 초고대역폭)"]
    A --> E["듀얼 NVMe SSD (PCIe Gen5 + Gen4)"]
    A --> F["USB4 C타입 x3 + Wi-Fi 7 + 2.5G LAN"]
```
...
| 부품 / 사양 | 세부 스펙 및 특징 |
| :--- | :--- |
| **프로세서 (CPU)** | **Qualcomm Snapdragon X2 Elite (18코어 3세대 Oryon CPU)**<br>(M4 Mac mini를 정조준한 초고성능 저전력 ARM 프로세서) |
| **AI 연산장치 (NPU)** | **80 TOPS Qualcomm Hexagon NPU ⭐**<br>(현존 미니 PC 중 최강의 로컬 온디바이스 AI 연산 능력) |
| **메모리 (RAM)** | **32GB LPDDR5x (9600MHz 초고클럭 온보드)**<br>(LLM 모델 로딩 및 고속 토큰 생성에 최적화) |
...
## 관련
- [[01_AI_시스템_및_도구/Dell_Latitude_7440_원클릭_원격세팅_가이드|Dell Latitude 7440 원격세팅 가이드]]
