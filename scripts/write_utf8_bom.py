...
ps1_content = """# Dell Latitude 7440 (Intel i5-1345U / 32GB RAM / Iris Xe) Antigravity Remote Hub Setup
param (
    [switch]$SkipOllama
)
...
Write-Host 'Dell Latitude 7440 Antigravity 2.0 Setup Complete!' -ForegroundColor Green
Write-Host '=================================================================' -ForegroundColor Green
...
with open(r'C:\전일도\setup_dell7440_laptop.bat', 'w', encoding='utf-8-sig') as f:
    f.write(bat_content)

print("Saved setup scripts with UTF-8-BOM successfully!")
